...
_G.packer_plugins = {
  ...
  ["nvim-web-devicons"] = {
    loaded = false,
    needs_bufread = false,
    path = "/var/home/mbarkmin/.local/share/nvim/site/pack/packer/opt/nvim-web-devicons",
  ...
  ["tokyonight.nvim"] = {
    loaded = true,
    path = "/var/home/mbarkmin/.local/share/nvim/site/pack/packer/start/tokyonight.nvim",
